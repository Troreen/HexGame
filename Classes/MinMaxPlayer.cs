...
namespace HexGame
{
    ...
    {
        public static int MaxDepth = 5; // You can adjust this as needed
        ...
        private int Minimax(GameBoard board, int depth, bool isMaximizing, int alpha, int beta, int maxDepth)
        {
            ...
            if (board.CheckWin(Marker, out _) || board.CheckWin(opponentMarker, out _) || IsBoardFull(board) || depth >= maxDepth)
